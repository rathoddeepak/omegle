...
const logo = 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e5/Logo_Omegle.svg/2880px-Logo_Omegle.svg.png';
...
function DemoMeetingTab({ label }: { label: string }) {
  ...
  return (
    <div className={styles.tabContent}>
      <p style={{ margin: 0 }}>Try Omegl for free get started by clicking below.</p>
    ...
    <>
      <main className={styles.main} data-lk-theme="default">
        <div className="header">
          <img src={logo} width="360" height="86.57" />
          <h2>
            Welcome to Omegle, the platform designed for spontaneous connections!
          </h2>
        </div>
